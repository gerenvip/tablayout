...
public class TabLayout extends HorizontalScrollView {
    ...
    public void setIndicatorInterpolator(Interpolator leftInterpolator, Interpolator rightInterpolator) {
        indicatorLeftInterpolator = leftInterpolator;
        indicatorRightInterpolator = rightInterpolator;
    }
    ...
    class SlidingTabIndicator extends LinearLayout {
            ...
            if (selectedTitle != null && selectedTitle.getWidth() > 0) {
                ...
                if (selectionOffset > 0f && selectedPosition < getChildCount() - 1) {
                    ...
                    if (tabIndicatorSticky) {
                        float leftFactor = indicatorLeftInterpolator.getInterpolation(selectionOffset);
                        float rightFactor = indicatorRightInterpolator.getInterpolation(selectionOffset);
                        left = (int) (leftFactor * nextTitleLeft + (1.0f - leftFactor) * left);
                        right = (int) (rightFactor * nextTitleRight + (1.0f - rightFactor) * right);
                    } else {
        ...
        private void updateOrRecreateIndicatorAnimation(
            ...
            if (!tabIndicatorFullWidth && targetView instanceof com.google.android.material.tabs.TabLayout.TabView) {
